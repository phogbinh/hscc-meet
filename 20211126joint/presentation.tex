...
\begin{frame}
  ...
  Furthermore,
  \begin{align*}
    \csFB\indicatorFull \csMinislotTime & = \vaResourceMinislot\\
    \csFB\indicatorFull   & = \vaResourceMinislot \csFB \csMinislot
  \end{align*}
\end{frame}
...
\begin{frame}
  ...
  \begin{align}
    ...
    \E \rvUrllcLoadMinislot & = \int_{0}^{\csFB\indicatorFull} \E \rvUrllcLoadMF df\nonumber\\
    ...
    & = \E D \vaResourceMinislot
  \end{align}
  Similar derivations for slot give
  \begin{equation}
    \label{eq:relation}
    \E \rvUrllcLoadSlot = \E D \vaResourceSlot
  \end{equation}
\end{frame}
