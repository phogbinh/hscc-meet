...
\newcommand
{\superposition}
{\sum_{ \subcarrier = 0 }^{ 611 }{ \amplitude \cos( 2 \pi \subcarrierSpacing \subcarrier \time + \phaseShift{\encodeBit{\subcarrier}{\curSymbol}} ) }}
  ...
  \begin{itemize}
    \item Pulse
      \begin{equation}
        ...
        \begin{cases}
          \amplitude \cos( 2 \pi \frac{ 1 }{ \symbolDuration } \subcarrier \time + \phaseShift{\bit} ) &\symbolDuration \symbol \leq \time < \symbolDuration \left( \symbol + 1 \right)\\
          0 &\otherwise
  ...
  \begin{itemize}
    \item Subcarrier signal
      \begin{align}
        ...
        &=
          \begin{cases}
            \amplitude \cos( 2 \pi \subcarrierFreq{\subcarrier} \time + \phaseShift{\encodeBit{\subcarrier}{\curSymbol}} ) &\symbolDuration \curSymbol \leq \time < \symbolDuration \left( \curSymbol + 1 \right)\\
            0 &\otherwise
          \end{cases}\\
        &=
          \begin{cases}
            \amplitude \cos( 2 \pi \subcarrierFreq{\subcarrier} \time ) &\symbolDuration \curSymbol \leq \time < \symbolDuration \left( \curSymbol + 1 \right), \encodeBit{\subcarrier}{\curSymbol} = 0\\
            \amplitude \cos( 2 \pi \subcarrierFreq{\subcarrier} \time + \pi ) &\symbolDuration \curSymbol \leq \time < \symbolDuration \left( \curSymbol + 1 \right), \encodeBit{\subcarrier}{\curSymbol} = 1\\
            0 &\otherwise
          \end{cases}
      \end{align}
  \end{itemize}
...
\begin{frame}
  \begin{equation}
    \subcarrierSignal{\subcarrier}{\curSymbol}{\time} =
      \begin{cases}
        \amplitude \cos( 2 \pi \subcarrierFreq{\subcarrier} \time ) &\symbolDuration \curSymbol \leq \time < \symbolDuration \left( \curSymbol + 1 \right), \encodeBit{\subcarrier}{\curSymbol} = 0\\
        -\amplitude \cos( 2 \pi \subcarrierFreq{\subcarrier} \time ) &\symbolDuration \curSymbol \leq \time < \symbolDuration \left( \curSymbol + 1 \right), \encodeBit{\subcarrier}{\curSymbol} = 1\\
        0 &\otherwise
  ...
  \begin{itemize}
    \item (Superpositioned) channel signal
      \begin{align*}
        ...
        &=
          \begin{cases}
            \sum_{ \subcarrier = 0 }^{ 611 }{ \amplitude \cos( 2 \pi \subcarrierFreq{\subcarrier} \time + \phaseShift{\encodeBit{\subcarrier}{\curSymbol}} ) } &\symbolDuration \curSymbol \leq \time < \symbolDuration \left( \curSymbol + 1 \right)\\
            0 &\otherwise
          \end{cases}\\
        &\unit{\voltage}
      \end{align*}
  ...
  \begin{itemize}
    \item Observation
      \begin{align*}
        ...
        = &\amplitude \cos( 2 \pi 0^{\unit{kHz}} \time + \phaseShift{\encodeBit{0}{\curSymbol}} ) + \dots +\\
        &\amplitude \cos( 2 \pi 660^{\unit{kHz}} \time + \phaseShift{\encodeBit{11}{\curSymbol}} )\\
        + &\dots\\
        + &\amplitude \cos( 2 \pi 36000^{\unit{kHz}} \time + \phaseShift{\encodeBit{600}{\curSymbol}} ) + \dots +\\
        &\amplitude \cos( 2 \pi 36660^{\unit{kHz}} \time + \phaseShift{\encodeBit{611}{\curSymbol}} )\\
...
\begin{frame}
  ...
  \begin{itemize}
    \item Subchannel frequency
      \begin{equation}
        \freq{\subchannel} = \freq{0} + \subchannel \subchannelBandwidth \unit{Hz},\quad \forall\subchannel
      \end{equation}
    \item 3D distance
      \begin{align*}
